...
export const ENTITY_DEFS: Record<string, EntityDef> = {
  ...
  cmdb: {
    ...
    fields: [
      ...
      { key: 'supported_by', label: 'Supported By (group name)', resolve: { table: 'assignment_groups', matchColumn: 'name' }, aliases: ['support_group', 'assignment_group'] },
      { key: 'location', label: 'Location (name)', resolve: { table: 'locations', matchColumn: 'name' }, aliases: ['site', 'location_name'] },
      { key: 'external_id_1', label: 'External ID 1', aliases: ['ext_id_1', 'externalid1', 'sys_id'] },
      { key: 'external_id_2', label: 'External ID 2', aliases: ['ext_id_2', 'externalid2'] },
      { key: 'is_active', label: 'Active', type: 'boolean', aliases: ['active', 'enabled'] },
