...
const TREND_CATALOG_PRESETS: DashboardWidgetCatalogEntry[] = [
  ...
  {
    catalogKey: 'trend.incidents_resolved',
    type: 'trend.chart',
    titleKey: 'widgets.trend.incidents_resolved',
    category: 'trends',
    defaultSize: { w: 6, h: 4 },
    defaultConfig: { dataset: 'incidents', metric: 'resolved', days: 30 },
    requiredRoles: ['admin', 'fulfiller'],
  },
  {
  ...
  {
    catalogKey: 'trend.problems_open_backlog',
    type: 'trend.chart',
    titleKey: 'widgets.trend.problems_open_backlog',
    category: 'trends',
    defaultSize: { w: 6, h: 4 },
    defaultConfig: { dataset: 'problems', metric: 'open_backlog', days: 30 },
    requiredRoles: ['admin', 'fulfiller'],
  },
];
