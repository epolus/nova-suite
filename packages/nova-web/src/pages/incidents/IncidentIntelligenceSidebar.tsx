...
import type { KnowledgeArticleDetail } from '../../api/client';
...
export function IncidentIntelligenceSidebar({ d }: { d: IncidentDetailState }) {
  const { similarIncidents, kbSuggestions, loadingSidebar, sidebarError, goTo, navigate } = d;
