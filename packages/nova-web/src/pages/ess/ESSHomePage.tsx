    ...
    <div ref={wrapperRef} className="relative w-full max-w-2xl mx-auto">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-4 text-base rounded-2xl border border-gray-200 shadow-md focus:outline-hidden focus:ring-2 focus:border-transparent bg-white placeholder-gray-400 text-gray-900"
    ...
    <div className="flex flex-col">
      ...
      <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 pb-12">
        <div className="rounded-xl bg-blue-50 border border-blue-100 px-5 py-4 flex items-start gap-3 dark:bg-slate-900/40 dark:border-slate-700">
          <svg className="w-5 h-5 text-blue-400 shrink-0 mt-0.5 dark:text-sky-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
