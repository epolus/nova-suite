...
import { resolveLocaleMessages, type MessageDict } from '../i18n/mergeMessages';
import { LocaleContext, type LocaleContextValue } from './LocaleContext';

const MESSAGE_CATALOGS: Record<AppLocale, MessageDict> = {
...
export function LocaleProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <LocaleContext.Provider value={value}>
      <IntlProvider locale={locale} messages={resolveLocaleMessages(locale, MESSAGE_CATALOGS)}>
        {children}
      </IntlProvider>
