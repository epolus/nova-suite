  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full pl-9 pr-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-hidden transition-shadow"
      />
      {local && (
        <button
