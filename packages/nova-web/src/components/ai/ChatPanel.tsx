  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-gray-50">
        ...
        <button type="button" onClick={onClose} className="p-1 text-gray-400 hover:text-gray-700 rounded-sm" aria-label={t('closeAriaLabel')}>
      ...
      <div className="p-3 border-t border-gray-100 flex gap-2">
        <input
          ...
          className="flex-1 rounded-lg border border-gray-300 px-3 py-2 text-sm outline-hidden focus:ring-2 focus:ring-indigo-500"
        />
        <button
          type="button"
          onClick={() => void send()}
