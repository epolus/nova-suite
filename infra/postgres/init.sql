...
INSERT INTO users (
  ...
  ('b0000000-0000-0000-0000-000000000005',
   'a0000000-0000-0000-0000-000000000001',
   'EMP005', 'network@acme.local',
   '$2b$10$WI5eBebgKFrYIXgHEKUdF.X7ogfJWMaDkLg7UUOb2paF8sUAjxf4y',
   'Nina', 'Network', 'Network Engineer', 'Senior Network Engineer',
  '+41 20 555 0104', '+41 6 5678 9012', 'Zurich HQ', 'Europe/Zurich', '24h', 'DD.MM.YYYY',
   'employee', 'a4000000-0000-0000-0000-000000000001', 'en',
   '2021-09-01',
   'a1000000-0000-0000-0000-000000000001',
   'a2000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000006',
   'a0000000-0000-0000-0000-000000000001',
   'EMP006', 'dba@acme.local',
   '$2b$10$WI5eBebgKFrYIXgHEKUdF.X7ogfJWMaDkLg7UUOb2paF8sUAjxf4y',
   'Omar', 'Database', 'Database Administrator', 'Senior DBA',
  '+41 20 555 0105', '+41 6 6789 0123', 'Zurich HQ', 'Europe/Zurich', '24h', 'DD.MM.YYYY',
   'employee', 'a4000000-0000-0000-0000-000000000001', 'en',
   '2020-11-15',
   'a1000000-0000-0000-0000-000000000001',
   'a2000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000007',
   'a0000000-0000-0000-0000-000000000001',
   'EMP007', 'appsupport@acme.local',
   '$2b$10$WI5eBebgKFrYIXgHEKUdF.X7ogfJWMaDkLg7UUOb2paF8sUAjxf4y',
   'Paula', 'Apps', 'Application Support Analyst', 'Application Support Lead',
  '+41 20 555 0106', '+41 6 7890 1234', 'Zurich HQ', 'Europe/Zurich', '24h', 'DD.MM.YYYY',
   'employee', 'a4000000-0000-0000-0000-000000000001', 'en',
   '2022-07-01',
   'a1000000-0000-0000-0000-000000000001',
   'a2000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000008',
   'a0000000-0000-0000-0000-000000000001',
   'EMP008', 'changemgr@acme.local',
   '$2b$10$WI5eBebgKFrYIXgHEKUdF.X7ogfJWMaDkLg7UUOb2paF8sUAjxf4y',
   'Chris', 'Change', 'Change Manager', 'IT Change Manager',
  '+41 20 555 0107', '+41 6 8901 2345', 'Zurich HQ', 'Europe/Zurich', '24h', 'DD.MM.YYYY',
   'employee', 'a4000000-0000-0000-0000-000000000001', 'en',
   '2019-04-01',
   'a1000000-0000-0000-0000-000000000001',
   'a2000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000009',
   'a0000000-0000-0000-0000-000000000001',
   'EMP009', 'sales@acme.local',
   '$2b$10$WI5eBebgKFrYIXgHEKUdF.X7ogfJWMaDkLg7UUOb2paF8sUAjxf4y',
   'Sara', 'Sales', 'Sara Sales', 'Account Executive',
  '+41 20 555 0108', '+41 6 9012 3456', 'Geneva Office', 'Europe/Zurich', '24h', 'DD.MM.YYYY',
   'employee', 'a4000000-0000-0000-0000-000000000001', 'en',
   '2023-05-20',
   'a1000000-0000-0000-0000-000000000005',
   'a2000000-0000-0000-0000-000000000005'),
  ('b0000000-0000-0000-0000-000000000010',
   'a0000000-0000-0000-0000-000000000001',
   'EMP010', 'finance@acme.local',
   '$2b$10$WI5eBebgKFrYIXgHEKUdF.X7ogfJWMaDkLg7UUOb2paF8sUAjxf4y',
   'Felix', 'Finance', 'Felix Finance', 'Financial Analyst',
  '+41 20 555 0109', '+41 6 0123 4567', 'Zurich HQ', 'Europe/Zurich', '24h', 'DD.MM.YYYY',
   'employee', 'a4000000-0000-0000-0000-000000000001', 'en',
   '2021-02-10',
   'a1000000-0000-0000-0000-000000000003',
   'a2000000-0000-0000-0000-000000000003');
...
UPDATE users SET manager_id = 'b0000000-0000-0000-0000-000000000002'
...
INSERT INTO user_roles (tenant_id, user_id, role_id, granted_by) VALUES
  ...
  ('a0000000-0000-0000-0000-000000000001',
   'b0000000-0000-0000-0000-000000000004',
   'a3000000-0000-0000-0000-000000000011', NULL),
  -- Network engineer gets fulfiller + user
  ('a0000000-0000-0000-0000-000000000001',
   'b0000000-0000-0000-0000-000000000005',
   'a3000000-0000-0000-0000-000000000002', NULL),
  ('a0000000-0000-0000-0000-000000000001',
  ...
  ('a0000000-0000-0000-0000-000000000001',
   'b0000000-0000-0000-0000-000000000006',
   'a3000000-0000-0000-0000-000000000003', NULL),
  -- Application support gets fulfiller + user
  ('a0000000-0000-0000-0000-000000000001',
   'b0000000-0000-0000-0000-000000000007',
   'a3000000-0000-0000-0000-000000000002', NULL),
  ('a0000000-0000-0000-0000-000000000001',
   'b0000000-0000-0000-0000-000000000007',
   'a3000000-0000-0000-0000-000000000003', NULL),
  -- Change manager gets change_manager + fulfiller + user
  ('a0000000-0000-0000-0000-000000000001',
   'b0000000-0000-0000-0000-000000000008',
   'a3000000-0000-0000-0000-000000000008', NULL),
  ('a0000000-0000-0000-0000-000000000001',
...
INSERT INTO assignment_groups (id, tenant_id, name, description, manager_id, cost_center_id) VALUES
  ...
  ('a5000000-0000-0000-0000-000000000003',
   'a0000000-0000-0000-0000-000000000001',
   'Application Support', 'Business application support and troubleshooting',
   'b0000000-0000-0000-0000-000000000007',
   'a2000000-0000-0000-0000-000000000001'),
  ('a5000000-0000-0000-0000-000000000004',
   'a0000000-0000-0000-0000-000000000001',
   'Database Administration', 'Database operations and performance',
   'b0000000-0000-0000-0000-000000000006',
   'a2000000-0000-0000-0000-000000000001'),
  ...
  ('a5000000-0000-0000-0000-000000000006',
   'a0000000-0000-0000-0000-000000000001',
   'Infrastructure & Hosting', 'Servers, virtualization, and cloud platforms',
   'b0000000-0000-0000-0000-000000000001',
   'a2000000-0000-0000-0000-000000000001');
...
INSERT INTO tenant_settings (tenant_id, key, value) VALUES
  ...
  ('a0000000-0000-0000-0000-000000000001', 'catalog_currency', 'CHF'),
...
INSERT INTO notification_rules (
  ...
  ('a0000000-0000-0000-0000-000000000001', 'Request fulfilled to requester', 'Notify requester when a request is fulfilled', 'request', 'request.fulfilled', 'requester', 'Request {request_number} fulfilled', 'Your request "{request_title}" has been fulfilled.', 40),
